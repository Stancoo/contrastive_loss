...
Indeed, in the range of ${\rm loss}<500$  it is difficult to notice the recovery inaccuracies. Only at ${\rm loss}>550$  they become noticeably pronounced (completely random case). This just indicates that the AE model is sufficiently fit for the selected 2-degree step rotated main group.