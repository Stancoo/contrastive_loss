...
"inference": {
	"results": "res_native",
```
The script will write 1000 of validation images into it as well as a histogram out of the collected losses (as two-column ASCII table of x- and y- values) - `histogram.dat`.
