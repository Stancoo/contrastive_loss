...
To demonstrate the advantage of the contrastive loss account on a particular example, as a  <a href="model_convlstm_ae.py">model</a> we take a <a href="https://link.springer.com/article/10.1007/s10489-022-03613-1">version </a> of the so-called Spatio-Temporal AE translated <a href="https://github.com/HSoo-Kim/SpatioTemporal-AutoEncoder"> into Pytorch</a>. The model is intended to binary classify the video fragments, i.e. as "normal/anomal". Training and testing procedures are configured in `config.json`:
