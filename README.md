...
At the same time, there are some side-effects observed as well. Contrastive treating of the defects affects few more outlier groups in a similar way. These are the $3$-degree (blue) and completely random rotations (turquoise). 