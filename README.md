...
What is really interesting, is the evolution seen in the last two pairs of columns representing our defects: with more epochs their recoveries are getting worse. This is exactly the result of inclusion of the contrastive loss terms in <a href="#loss">loss expression</a>).